          ...
          <div class="row py-2">
            ...
            <div class="col-12 sm:col-6 !py-1.5">
              <div class="db-list-item p-0">
                ...
                <span class="db-list-item-text w-full sm:w-1/2">{{ expense.paymentMethod }}</span>
              </div>
            </div>
            ...
            <div class="col-12 sm:col-6 !py-1.5">
              <div class="db-list-item p-0">
                ...
                <span class="db-list-item-text w-full sm:w-1/2">{{ expense.isRecurring }}</span>
              </div>
            </div>
            ...
            <div class="col-12 sm:col-6 !py-1.5">
              <div class="db-list-item p-0">
                ...
                <span class="db-list-item-text w-full sm:w-1/2">{{ expense.recurs }}</span>
              </div>
            </div>
